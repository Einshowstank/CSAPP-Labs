...
0000000000400be0 <initCache>:
  ...
  400bef:	48 98                	cltq   
  400bf1:	48 c1 e0 03          	shl    $0x3,%rax                  # S = S* 8
  ...
  400c3b:	48 89 c7             	mov    %rax,%rdi                 # E = 24 *E
  ...
  400c59:	8b 55 e8             	mov    -0x18(%rbp),%edx # i
  400c5c:	48 63 d2             	movslq %edx,%rdx # i
  400c5f:	48 c1 e2 03          	shl    $0x3,%rdx # 8 * i
  400c63:	48 01 d0             	add    %rdx,%rax # 603128 <cache> + 8 * i
  400c66:	48 8b 08             	mov    (%rax),%rcx # cache[i]
  400c69:	8b 45 ec             	mov    -0x14(%rbp),%eax # j
  400c6c:	48 63 d0             	movslq %eax,%rdx
  400c6f:	48 89 d0             	mov    %rdx,%rax
  400c72:	48 01 c0             	add    %rax,%rax
  400c75:	48 01 d0             	add    %rdx,%rax
  400c78:	48 c1 e0 03          	shl    $0x3,%rax      # 24 * j
  400c7c:	48 01 c8             	add    %rcx,%rax      # &cache[i][j]
  ...
  400d09:	39 45 e8             	cmp    %eax,-0x18(%rbp)           # if (S > 0) jmp;
...
00000000004012b3 <main>:
  ...
  401370:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx  #传第二个参数
  401374:	8b 45 ec             	mov    -0x14(%rbp),%eax  #传第一个参数
  ...
  401389:	80 7d ff ff          	cmpb   $0xff,-0x1(%rbp)  #返回值是否为-1
  40138d:	0f 85 34 ff ff ff    	jne    4012c7 <main+0x14> #不是就跳转
