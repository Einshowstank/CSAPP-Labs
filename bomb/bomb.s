...
0000000000400efc <phase_2>:
  ...
  400f1c:	39 03                	cmp    %eax,(%rbx) 与当前元素比较要相等，说明是等比数组
...
0000000000400fce <func4>: 参数(&A[2], 0, 14, &A[3]])
  ...
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> 如果val2(7) 小于等于 A[2]跳转
...
0000000000401062 <phase_5>: 设输入第一个参数为input1
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx  保存input1地址到%rbx
  ...
  40108f:	88 0c 24             	mov    %cl,(%rsp)    栈+0字节保存 input1
  401092:	48 8b 14 24          	mov    (%rsp),%rdx   %rdx 保存input1
...
00000000004010f4 <phase_6>:
  ...
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx  循环遍历数组6个元素
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> 小于等于1则进入循环
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax 保存第2个选取的链表节点
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) 从新构建来链表，*next保存下个节点地址
  4011c4:	48 83 c0 08          	add    $0x8,%rax       保存第2+i个选取的链表节点 i(1~4)
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> 到第6个节点了跳出循环
  4011cd:	48 89 d1             	mov    %rdx,%rcx       保存第（2~6）个选取的链表节点
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx 保存第一个参数
  40133f:	48 89 f5             	mov    %rsi,%rbp 保存第二个参数
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d 保存第一个字符串长度
  40134a:	48 89 ef             	mov    %rbp,%rdi 第二个参数复制到参数1寄存器
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx 返回值设置为1，代表不相等
  401357:	41 39 c4             	cmp    %eax,%r12d 比较两个参数字符串长度
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63> 不相等的话返回1
  40135c:	0f b6 03             	movzbl (%rbx),%eax 返回值设置为第一个参数字符串
  40135f:	84 c0                	test   %al,%al
  401361:	74 25                	je     401388 <strings_not_equal+0x50> 两个字符串均为空，返回0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al 比较2个字符串
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57> 不相等的话返回1
...
000000000040145c <read_six_numbers>:
  ...
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt> rdi, rsi, rdx, rcx, r8, r9, (%rsp),8(%rsp)
